...
class City(models.Model):
    ...
    pid = models.ForeignKey('Provincial', models.DO_NOTHING, db_column='pid')
...
class DcyDelivery(models.Model):
...
class ImageCollectionImg(models.Model):
    ...
    upload_username = models.CharField(max_length=45, blank=True, null=True)
